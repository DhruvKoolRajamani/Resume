  ...
  \resumeSubHeadingListStart
        ...
        \resumeItem{Implementation of Walking Controller COMAN Robot(COmpliant HuMANoid Platform)}
          {
            ...
            \begin{table}[h]
              \centering
              \begin{tabular}{lll}
              \textit {\href {https://gitlab.com/DhruvKoolRajamani/coman-orocos-pkg}{OROCOS-Package Project Page}} \hspace{6mm} & \textit {\href {https://gitlab.com/DhruvKoolRajamani/coman-ros-pkg}{ROS-Package Project Page}} \hspace{6mm} & \href{https://drive.google.com/file/d/1S0IkrxoQXY0n0S7rTOv_ScfWWCMtWp8q/view?usp=sharing}{Validation through Comparison}
              \end{tabular}
              \end{table}
              \vspace{-2mm}
          }
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \begin{center}
          \href{https://drive.google.com/file/d/1uMgh2ZqcdT_HL28xcz5YuUoSw65T8-Bo/view?usp=sharing}{Simulation demonstrating the trajectory based control of a 4-link manipulator}
        \end{center}
      \resumeItemListEnd
        ...
        \resumeItem{Development of a Mars Rover Prototype}
          {
            \begin{flushleft}
              ...
              \begin{itemize}
                \item Best Rover team from Asia, 8th out of 82 teams at the URC 2017.
              \end{itemize}
            \end{flushleft}
          }
